...
packages:
  ...
  '@sentry/electron@7.7.0':
    resolution: {integrity: sha512-2BapanbCoAzrw7nFoP1vS05+O/sLNakhoXI3tyoGMWpSNZiSCYTf50d9D6zp/U3FeHGKhZrcQ4SdBKEwgRXGJA==}
    peerDependencies:
  ...
  '@sentry/node-core@10.36.0':
    resolution: {integrity: sha512-3K2SJCPiQGQMYSVSF3GuPIAilJPlXOWxyvrmnxY9Zw3ZbXaLynhYCJ5TjL38hS7XoMby/0lN2fY/kbXH/GlNeg==}
    engines: {node: '>=18'}
    peerDependencies:
      '@opentelemetry/api': ^1.9.0
  ...
  '@sentry/node@10.36.0':
    resolution: {integrity: sha512-c7kYTZ9WcOYqod65PpA4iY+wEGJqLbFy10v4lIG6B5XrO+PFEXh1CrvGPLDJVogbB/4NE0r2jgeFQ+jz8aZUhw==}
    engines: {node: '>=18'}

  '@sentry/opentelemetry@10.36.0':
    resolution: {integrity: sha512-TPOSiHBk45exA/LGFELSuzmBrWe1MG7irm7NkUXCZfdXuLLPeUtp1Y+rWDCWWNMrraAdizDN0d/l1GSLpxzpPg==}
    engines: {node: '>=18'}
    peerDependencies:
      '@opentelemetry/api': ^1.9.0
      '@opentelemetry/context-async-hooks': ^1.30.1 || ^2.1.0
  ...
  '@sentry/types@10.36.0':
    resolution: {integrity: sha512-ihYStv8A7vxBbelVuyVwdSMrWAhYNbu/2dSAFBgxT6gRmMByutOIqTW4YNDU4Cv4nuddujiWPuPbGdVpbqEOPQ==}
    engines: {node: '>=18'}
