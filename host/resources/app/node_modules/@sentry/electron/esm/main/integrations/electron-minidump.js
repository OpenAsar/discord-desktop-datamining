...
import { defineIntegration, convertIntegrationFnToClass, getCurrentScope, applyScopeDataToEvent } from '@sentry/core';
...
const electronMinidumpIntegration = defineIntegration(() => {
    ...
    function getNativeUploaderEvent(scope) {
        return __awaiter(this, void 0, void 0, function* () {
            const event = mergeEvents(yield getEventDefaults(customRelease), {
                sdk: getSdkInfo(),
                event_id: uuid4(),
                level: 'fatal',
                platform: 'native',
    ...
    return {
        ...
        setup(client) {
            ...
            unreportedDuringLastSession((_a = crashReporter.getLastCrashReport()) === null || _a === void 0 ? void 0 : _a.date).then((crashed) => {
...
const ElectronMinidump = convertIntegrationFnToClass(INTEGRATION_NAME, electronMinidumpIntegration);

export { ElectronMinidump, electronMinidumpIntegration, minidumpUrlFromDsn };
