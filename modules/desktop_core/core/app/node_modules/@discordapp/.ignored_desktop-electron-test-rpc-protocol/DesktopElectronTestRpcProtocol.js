...
let RpcCallType = exports.RpcCallType = function (RpcCallType) {
  ...
  RpcCallType[RpcCallType["execute"] = 5] = "execute";
  return RpcCallType;
}({});
let RpcResponseType = exports.RpcResponseType = function (RpcResponseType) {
