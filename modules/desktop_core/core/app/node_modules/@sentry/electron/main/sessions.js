...
exports.endSessionOnExit = exports.sessionCrashed = exports.checkPreviousSession = exports.unreportedDuringLastSession = exports.endSession = exports.startSession = void 0;
...
function endSessionOnExit() {
    ...
    electron_1.app.on('before-quit', () => {
        ...
        electron_1.app.removeListener('will-quit', exitHandler);
        electron_1.app.on('will-quit', exitHandler);
    });
}
exports.endSessionOnExit = endSessionOnExit;
/** Handles the exit */
const exitHandler = (event) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    if (event.defaultPrevented) {
        return;
    }
    utils_1.logger.log('[Session] Exit Handler');
    ...
    try {
        ...
        utils_1.logger.warn('[Session] Error ending session:', e);
    }
    electron_1.app.exit();
});
