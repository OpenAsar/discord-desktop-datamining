...
function startup(bootstrapModules) {
    ...
    const { moduleUpdater } = require('./bootstrapModules/moduleUpdater');
    const { updater } = require('./bootstrapModules/updater');
    require('./bootstrapModules/autoStart');
    const { buildInfo } = require('./bootstrapModules/buildInfo');
    const { appSettings } = require('./bootstrapModules/appSettings');
    ...
    const { crashReporterSetup } = require('./bootstrapModules/crashReporterSetup');
    ...
    const { setupClipsProtocol } = require('./discord_native/browser/clips');
    setupClipsProtocol();
    ...
    mainScreen.init();
    const { getWindow: getPopoutWindowByKey, getAllWindows: getAllPopoutWindows, setNewWindowEvent, } = require('./popoutWindows');
