...
const { GPU_SETTINGS_SET_ENABLE_HWACCEL, GPU_SETTINGS_GET_ENABLE_HWACCEL_SYNC, GPU_SETTINGS_SET_CHROMIUM_SWITCHES, GPU_SETTINGS_SET_SETTING, } = require('../common/constants').IPCEvents;
