...
const RENDERER_IPC_SEND_WHITELIST = new Set([IPCEvents.APP_ASYNC_INDEX_TSX_LOADED, IPCEvents.APP_BADGE_SET, IPCEvents.APP_FIRST_RENDER_AFTER_READY_PAYLOAD, IPCEvents.APP_GET_ANALYTICS_EVENTS, IPCEvents.APP_LOADED, IPCEvents.APP_PUSH_ANALYTICS, IPCEvents.APP_VIEWED, IPCEvents.CHECK_FOR_UPDATES, IPCEvents.NAVIGATION_HISTORY_CLEAR, IPCEvents.NOTIFICATION_CLOSE, IPCEvents.NOTIFICATION_SHOW, IPCEvents.NOTIFICATIONS_CLEAR, IPCEvents.OPEN_EXTERNAL_URL, IPCEvents.QUIT_AND_INSTALL, IPCEvents.SETTINGS_UPDATE_BACKGROUND_COLOR, IPCEvents.SYSTEM_TRAY_SET_ICON, IPCEvents.SYSTEM_TRAY_SET_APPLICATIONS, IPCEvents.THUMBAR_BUTTONS_UPDATE, IPCEvents.TOGGLE_MINIMIZE_TO_TRAY, IPCEvents.TOGGLE_OPEN_ON_STARTUP, IPCEvents.TOGGLE_START_MINIMIZED, IPCEvents.UPDATE_OPEN_ON_STARTUP, IPCEvents.UPDATER_HISTORY_QUERY_AND_TRUNCATE, IPCEvents.UPDATED_QUOTES, IPCEvents.WINDOW_SET_TRAFFIC_LIGHT_POSITION]);
