...
const RENDERER_IPC_SEND_WHITELIST = new Set([_constants.IPCEvents.APP_ASYNC_INDEX_TSX_LOADED, _constants.IPCEvents.APP_BADGE_SET, _constants.IPCEvents.APP_FIRST_RENDER_AFTER_READY_PAYLOAD, _constants.IPCEvents.APP_GET_ANALYTICS_EVENTS, _constants.IPCEvents.APP_MAIN_BUNDLE_STATS, _constants.IPCEvents.APP_LOADED, _constants.IPCEvents.APP_PUSH_ANALYTICS, _constants.IPCEvents.APP_VIEWED, _constants.IPCEvents.CHECK_FOR_UPDATES, _constants.IPCEvents.NAVIGATION_HISTORY_CLEAR, _constants.IPCEvents.NOTIFICATION_CLOSE, _constants.IPCEvents.NOTIFICATION_SHOW, _constants.IPCEvents.NOTIFICATIONS_CLEAR, _constants.IPCEvents.OPEN_EXTERNAL_URL, _constants.IPCEvents.QUIT_AND_INSTALL, _constants.IPCEvents.SETTINGS_UPDATE_BACKGROUND_COLOR, _constants.IPCEvents.SYSTEM_TRAY_SET_ICON, _constants.IPCEvents.SYSTEM_TRAY_SET_APPLICATIONS, _constants.IPCEvents.THUMBAR_BUTTONS_UPDATE, _constants.IPCEvents.TOGGLE_MINIMIZE_TO_TRAY, _constants.IPCEvents.TOGGLE_OPEN_ON_STARTUP, _constants.IPCEvents.TOGGLE_START_MINIMIZED, _constants.IPCEvents.UPDATE_OPEN_ON_STARTUP, _constants.IPCEvents.UPDATER_HISTORY_QUERY_AND_TRUNCATE, _constants.IPCEvents.UPDATED_QUOTES, _constants.IPCEvents.WINDOW_SET_TRAFFIC_LIGHT_POSITION]);
