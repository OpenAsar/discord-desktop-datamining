...
async function readTimeSeriesLogFiles(maxSize, blindChannelId) {
  ...
  const voicePath = _path.default.join(modulePath, 'discord_voice'); // Example filename: "channel.17812072731293278934.16605628624321906260.tsi"
  ...
  const readfiles = await readFulfilledFiles(filenames, maxSize, false); // Delete the files after they've been read.
